...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Markian Hromiak");
        toPrint += p1.toString("mhromiak3");
        // Person2 replace P2 with your name
        // and gburdell with your gt id
        Person2 p2 = new Person2("Ben Holmes");
        toPrint += p2.toString("bholmes34");
        // Person3 replace P3 with your name
        // and gburdell3 with your gt id
        Person3 p3 = new Person3("Sirila Padi");
        toPrint += p3.toString("spadi3");
        // Person4 replace P4 with your name
        // and gburdell4 with your gt id
        Person4 p4 = new Person4("Mike Lewis");
        toPrint += p4.toString("mlewis61");
        // Person5 replace P4 with your name
        // and gburdell5 with your gt id
        Person5 p5 = new Person5("Sho Szczepaniuk");
        toPrint += p5.toString("sszczepaniuk3");
